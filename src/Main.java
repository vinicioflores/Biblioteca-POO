...
public class Main {
	...
	private void initialize() {
		...
		frmBibliotecaAlejandrina.setFocusTraversalPolicy(new FocusTraversalOnArray(new Component[]{menuBar, mnArchivo, mntmCargarRegistro, mntmCargarColeccion, mntmSalir, mnRegistro, mntmNuevoCliente, mntmEliminarCliente, mntmGuardarRegistroActual, mnColeccion, mntmNuevoLibro, mntmEliminarLibro, mntmGuardarColeccionActual}));
	}
